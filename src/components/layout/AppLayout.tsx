                    ...
                    <SidebarMenu>
                      ...
                      <>
                          ...
                          className={cn(
                            ...
                            "hover:bg-muted"
                          )} style={{ backgroundColor: "#f8f8f8", backgroundImage: "none", color: "#010101" }}>
                ...
                <div className="flex h-16 items-center border-b px-6">
                  <Link href="/dashboard" className="flex items-center gap-2 font-semibold">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary text-primary-foreground" style={{ backgroundColor: "transparent", backgroundImage: "url(\"/LOGO-2015-C_B.gif\")", backgroundSize: "cover" }}>
                      <span className="text-lg font-bold" style={{ backgroundImage: "url(\"/LOGO-2015-C_B.gif\")", backgroundColor: "transparent", backgroundSize: "contain", color: "rgba(0, 0, 0, 0)", lineHeight: "", backgroundRepeat: "no-repeat", fontWeight: "100" }}>.</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-sm font-bold leading-tight">OK Lubnik</span>
